...
<head>
    ...
    <style>
        ...
        .hero-gradient { background: linear-gradient(135deg, rgba(0,0,0,0.8) 0%, rgba(28,94,130,0.6) 100%); }
...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen selection:bg-unmerBlue selection:text-white">
    ...
    <section class="relative min-h-[550px] lg:min-h-[650px] flex items-center justify-center text-center overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat transform scale-105 duration-1000 ease-in-out" style="background-image: url('{{ asset('images/unmer.jpg') }}');"></div>
        <div class="absolute inset-0 hero-gradient"></div>
        <div class="relative z-10 px-6 max-w-5xl mx-auto flex flex-col items-center animate-fade-in-up">
            <span class="px-4 py-1.5 rounded-full border border-white/20 bg-white/10 text-white/90 text-xs font-semibold tracking-[0.2em] uppercase mb-6 backdrop-blur-sm">
                Sistem Informasi Terpadu
            </span>
            <h2 class="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight tracking-tight drop-shadow-lg">
                Pusat Teknologi Informasi <br/> <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">& Multimedia</span>
            </h2>
            <p class="text-lg md:text-2xl text-blue-50 font-light max-w-3xl mx-auto drop-shadow-md leading-relaxed mb-10">
                Membangun ekosistem akademik cerdas Universitas Merdeka Malang melalui integrasi layanan digital yang elegan dan profesional.
            </p>
        </div>
    </section>
    ...
    <main class="flex-grow py-24 bg-gray-50/50 relative">
        ...
        <div class="container mx-auto px-6 max-w-6xl relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-4xl mx-auto animate-fade-in-up" style="animation-delay: 0.4s;">
                <a href="#" class="group glass-card p-10 rounded-3xl flex flex-col items-center justify-center hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(28,94,130,0.08)] hover:border-unmerBlue/40 transition-all duration-500">
                    <div class="w-16 h-16 rounded-2xl bg-blue-50 text-unmerBlue flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 group-hover:bg-unmerBlue group-hover:text-white">
                    ...
                    <p class="text-gray-500 mt-3 text-center font-light text-sm">Akses administrasi mengajar dan penelitian</p>
                </a>
                <a href="#" class="group glass-card p-10 rounded-3xl flex flex-col items-center justify-center hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(28,94,130,0.08)] hover:border-unmerBlue/40 transition-all duration-500">
                    <div class="w-16 h-16 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 group-hover:bg-indigo-600 group-hover:text-white">
                    ...
                    <p class="text-gray-500 mt-3 text-center font-light text-sm">Akses sistem akademik dan e-learning</p>
                </a>
            </div>
        </div>
    </main>
