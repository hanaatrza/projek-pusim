...
<head>
    ...
    <style>
        ...
        .text-gradient {
            background: linear-gradient(135deg, #1c5e82 0%, #3b82f6 100%);
...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen selection:bg-unmerBlue selection:text-white">
    ...
    <section class="relative h-[450px] lg:h-[500px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div class="relative z-10 px-6 max-w-4xl mx-auto flex flex-col items-center">
            <span
                class="px-4 py-1 rounded-full border border-white/20 bg-white/10 text-white/90 text-[10px] font-bold tracking-[0.3em] uppercase mb-5">Tentang
                Kami</span>
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight">Profil Instansi
            </h2>
            <p class="text-blue-50 text-xl font-light tracking-wide max-w-2xl">Pusat Teknologi Informasi dan Multimedia
                Universitas Merdeka Malang</p>
        </div>
    </section>
    ...
    <main class="flex-grow container mx-auto px-6 py-24 max-w-6xl">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div class="space-y-8">
                <div>
                    <h3 class="text-4xl font-bold text-gray-900 tracking-tight mb-4">Mengenal <span
                            class="text-gradient">PUSIM</span></h3>
                ...
                <div class="space-y-6 text-gray-600 font-light text-lg leading-relaxed text-justify">
                    ...
                    <div class="p-6 bg-blue-50/50 border-l-4 border-unmerBlue rounded-r-2xl italic font-medium">
                        Kami berkomitmen untuk menghadirkan inovasi digital yang mendukung proses akademik,
            ...
            <div class="space-y-8">
                <div class="glass-card p-10">
                    <div class="flex items-center gap-4 mb-6">
                        <div
                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-unmerBlue to-unmerDark flex items-center justify-center text-white shadow-lg">
                ...
                <div class="glass-card p-10">
                    <div class="flex items-center gap-4 mb-6">
                        <div
                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-white shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <ul class="space-y-4 text-gray-600 font-light leading-relaxed list-none text-[15px]">
                        <li class="flex items-start gap-4">
                            <div class="w-2 h-2 mt-2 rounded-full bg-orange-400 shrink-0"></div>Menyelenggarakan program
                            pendidikan tinggi berkualitas bereputasi.
                        </li>
                        <li class="flex items-start gap-4">
                            <div class="w-2 h-2 mt-2 rounded-full bg-orange-400 shrink-0"></div>Menyelenggarakan
                            kegiatan penelitian dan publikasi ilmiah unggul.
                        </li>
                        <li class="flex items-start gap-4">
                            <div class="w-2 h-2 mt-2 rounded-full bg-orange-400 shrink-0"></div>Melaksanakan tata kelola
                            universitas yang cerdas berbasis Sistem Informasi Manajemen.
                        </li>
                    </ul>
                </div>
            </div>
