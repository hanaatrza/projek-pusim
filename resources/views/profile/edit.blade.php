        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="{{ route('profile.update') }}" method="POST" class="p-8">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Demi keamanan, Anda wajib memasukkan kata sandi saat ini untuk menyimpan perubahan pada profil Anda.</p>

                    <div class="max-w-md">
                        <label for="current_password" class="block text-sm font-semibold text-gray-700 mb-2">Kata Sandi Saat Ini <span class="text-red-500">*</span></label>
                ...
                <div class="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mb-6">Biarkan kosong jika Anda tidak ingin mengubah kata sandi baru.</p>
