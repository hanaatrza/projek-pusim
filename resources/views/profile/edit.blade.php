    ...
    <main class="flex-grow container mx-auto px-4 py-8 max-w-5xl fade-in">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-2 text-sm md:text-base">Kelola informasi pribadi dan pengaturan keamanan akun
                    Anda.</p>
            </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/3">
                <div
                    class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center text-center sticky top-24">
                    <div class="relative mb-5">
                        <div
                            class="w-28 h-28 rounded-full bg-gradient-to-tr from-unmerBlue to-cyan-500 text-white flex items-center justify-center font-bold text-4xl shadow-lg ring-4 ring-blue-50">
                            {{ substr(Auth::user()->name, 0, 1) }}
                        </div>
                    ...
                    <div class="w-full border-t border-gray-100 mt-8 pt-6 space-y-4">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span
                                class="font-semibold text-green-600 bg-green-50 px-2.5 py-0.5 rounded-full">Terverifikasi</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-500 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            ...
                            <span
                                class="font-medium text-gray-900">{{ Auth::user()->created_at ? Auth::user()->created_at->format('M Y') : 'Baru-baru ini' }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="border-b border-gray-100 bg-gray-50/50 p-6">
                            <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-unmerBlue" fill="none"
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                <label for="email"
                                    class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Alamat
                                    Email</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div
                                class="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3 text-sm text-blue-900">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 flex-shrink-0 mt-0.5 text-blue-500" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <p><strong>Verifikasi Wajib:</strong> Masukkan kata sandi saat ini untuk menyimpan
                                    perubahan pada profil Anda, termasuk nama dan email.</p>
                            </div>

                            <div class="space-y-4">
                                <div>
                                    <label for="current_password"
                                        class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Kata
                                        Sandi Saat Ini <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <div
                                ...
                                <div class="pt-4 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="col-span-full mb-1">
                                        <h4 class="text-sm font-semibold text-gray-800">Ubah Kata Sandi <span
                                                class="text-gray-400 font-normal">(Opsional)</span></h4>
                                        <p class="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah sandi.
                                        </p>
                                    </div>
                                    <div>
                                        <label for="password"
                                            class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Sandi
                                            Baru</label>
                                    ...
                                    <div>
                                        <label for="password_confirmation"
                                            class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Konfirmasi
                                            Sandi Baru</label>
