...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow container mx-auto px-4 py-8 max-w-7xl fade-in">
        ...
        <div id="ticketModal" class="fixed inset-0 z-[100] hidden overflow-y-auto" aria-labelledby="modal-title"
                ...
                <div
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 relative">
                        ...
                        <button onclick="closeModal()" type="button"
                            class="absolute top-4 right-4 text-gray-400 hover:text-gray-500 hover:bg-gray-100 p-1 rounded-full transition-colors focus:outline-none">
                        ...
                        <div class="sm:flex sm:items-start">
                            <div
                                ...
                                <svg class="h-6 w-6 text-unmerBlue" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                <h3 class="text-xl font-bold leading-6 text-gray-900" id="modal-title">Buat Tiket
                                    Layanan Baru</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Silakan isi formulir di bawah ini untuk mengajukan
                                ...
                                <form id="ticketForm" class="mt-5 space-y-4" action="#" method="POST"
                                    ...
                                    <div>
                                        <label for="judul"
                                            class="block text-sm font-medium text-gray-700 text-left">Judul Kendala /
                                            Permohonan</label>
                                        <input type="text" name="judul" id="judul" required
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-unmerBlue focus:ring-unmerBlue sm:text-sm p-2 border"
                                            placeholder="Misal: Reset Password Siakad">
                                    </div>

                                    <div>
                                        <label for="kategori"
                                            class="block text-sm font-medium text-gray-700 text-left">Kategori
                                            Layanan</label>
                                        <select id="kategori" name="kategori" required
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-unmerBlue focus:ring-unmerBlue sm:text-sm p-2.5 border bg-white">
                                    ...
                                    <div>
                                        <label for="deskripsi"
                                            class="block text-sm font-medium text-gray-700 text-left">Deskripsi
                                            Lengkap</label>
                                        <textarea id="deskripsi" name="deskripsi" rows="4" required
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-unmerBlue focus:ring-unmerBlue sm:text-sm p-2 border"
                                            placeholder="Jelaskan secara detail kendala atau layanan yang Anda butuhkan..."></textarea>
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 text-left">Lampiran
                                            (Opsional)</label>
                                        <div
                                            class="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6 hover:bg-gray-50 transition-colors">
                                            <div class="space-y-1 text-center">
                                                ...
                                                <div class="flex text-sm text-gray-600 justify-center">
                                                    <label for="file-upload"
                                                        class="relative cursor-pointer rounded-md bg-white font-medium text-unmerBlue focus-within:outline-none focus-within:ring-2 focus-within:ring-unmerBlue focus-within:ring-offset-2 hover:text-unmerDark">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        <button type="button" onclick="closeModal()"
                            class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-unmerBlue focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm transition-colors">
                            Batal
                        </button>
                    </div>
                </div>
