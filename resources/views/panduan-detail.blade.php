...
<head>
    ...
    <style>
        body { font-family: 'Open Sans', sans-serif; background-color: #f8fafc; }
...
<body class="flex flex-col min-h-screen">
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <a href="{{ url('/') }}" class="flex items-center gap-3">
                <img src="{{ asset('oip.jpeg') }}" alt="Logo" class="h-10">
    ...
    <div class="bg-blue-600 text-white py-12">
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="text-blue-200 mb-2 text-sm font-semibold uppercase tracking-wider">{{ $knowledgeBase->category }}</div>
    ...
    <main class="flex-grow container mx-auto px-4 py-8 max-w-4xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="mt-12 pt-6 border-t border-gray-100 flex justify-between items-center text-sm text-gray-500">
                ...
                <a href="{{ route('panduan.public') }}" class="text-blue-600 font-semibold hover:underline">← Kembali ke Daftar Panduan</a>
            </div>
        </div>
    </main>
