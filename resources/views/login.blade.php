                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="password" name="password" placeholder="••••••••" required
                                class="input-elegant w-full px-5 py-4 rounded-xl text-sm font-medium tracking-widest pr-12">
                            <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-4 flex items-center text-gray-400 hover:text-unmerBlue transition-colors focus:outline-none">
