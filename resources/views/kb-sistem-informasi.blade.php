...
<head>
    ...
    <title>Sistem Informasi - PUSIM</title>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: { colors: { unmerBlue: '#206d94', unmerDark: '#1a4f6b',}, fontFamily: { sans: ['Plus Jakarta Sans', 'sans-serif'],},}
            }
        }
    </script>
</head>
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow container mx-auto px-4 py-8 max-w-4xl">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 md:ml-2 text-gray-400 font-medium">Sistem Informasi</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 flex items-center">
            <div class="w-16 h-16 bg-green-50 text-green-600 rounded-xl flex items-center justify-center mr-6">
            ...
            <div>
                ...
                <p class="text-gray-500 mt-2">Daftar panduan penggunaan aplikasi pendukung civitas seperti Elearning.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <ul class="divide-y divide-gray-100">
                <li>
                    <a href="{{ url('/dashboard/basis-pengetahuan/sinkron-elearning') }}" class="block p-6 hover:bg-green-50 transition-colors group">
                        <h4 class="text-lg font-bold text-gray-900 group-hover:text-green-600">Panduan Sinkronisasi Kelas Elearning</h4>
                        <p class="text-sm text-gray-500 mt-1">Bagi Dosen yang perlu menarik data enrolment dari Siakad ke Elearning.</p>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/dashboard/basis-pengetahuan/presensi-online') }}" class="block p-6 hover:bg-green-50 transition-colors group">
                        <h4 class="text-lg font-bold text-gray-900 group-hover:text-green-600">Presensi Karyawan dan Dosen Online</h4>
                        <p class="text-sm text-gray-500 mt-1">Menggunakan aplikasi finger dan web absensi biro administrasi.</p>
                    </a>
                </li>
            </ul>
        </div>
