...
<head>
    ...
    <style>
        ...
        .number-overlay {
            -webkit-text-stroke: 1px rgba(28, 94, 130, 0.2);
...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen selection:bg-unmerBlue selection:text-white">
    ...
    <section class="relative h-[450px] lg:h-[500px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div class="relative z-10 px-6 max-w-4xl mx-auto flex flex-col items-center">
            <span
                class="px-4 py-1 rounded-full border border-white/20 bg-white/10 text-white/90 text-[10px] font-bold tracking-[0.3em] uppercase mb-5">Fasilitas
                Kampus</span>
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight">Layanan Sivitas
            </h2>
            <p class="text-blue-50 text-xl font-light tracking-wide max-w-2xl">Eskplorasi integrasi ekosistem akademik
                dan administratif cerdas Universitas Merdeka.</p>
        </div>
    </section>
    ...
    <main class="flex-grow container mx-auto px-6 py-24 max-w-5xl">
        <div class="space-y-12">
            <div class="glass-card p-10 md:p-14 relative overflow-hidden group">
                <div
                    class="absolute top-0 right-0 p-8 text-[120px] font-black number-overlay leading-none select-none group-hover:scale-110 transition-transform duration-700">
                    01</div>
                <div class="relative z-10 max-w-3xl">
                    ...
                    <p class="text-gray-600 text-lg font-light leading-relaxed text-justify">
                        PUSIM Universitas Merdeka Malang berkomitmen mendukung transformasi digital di lingkungan
                        universitas dengan menyediakan infrastruktur layanan teknologi informasi berstandar tinggi yang
                        terintegrasi. Hal ini ditujukan untuk mempermudah kegiatan operasional akademik harian, baik
                        untuk Dosen, Mahasiswa, hingga Staf Administratif.
                    </p>
                </div>
            </div>
            ...
            <div class="glass-card p-10 md:p-14 relative overflow-hidden group">
                ...
                <div class="relative z-10 max-w-3xl">
                    ...
                    <div class="w-12 h-1 bg-gradient-to-r from-unmerBlue to-blue-300 rounded-full mb-8"></div>
                    <p class="text-gray-600 text-lg font-light leading-relaxed text-justify">
                        Kami menyediakan antarmuka interaktif yang cepat untuk berbagai fasilitas IT demi mewujudkan
                        kampus masa depan yang terkoneksi mutlak. Seluruh kebutuhan pengisian KRS, informasi transkrip,
                        hingga portal bimbingan riset kini dapat diakses dalam genggaman secara riil dan terpadu.
                    </p>
                </div>
            </div>
        </div>
